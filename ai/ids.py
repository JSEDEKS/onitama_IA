...
from ai.minimax import decision
...
def ids_decision(state, max_time: float = 3.0) -> tuple:
    ...
    #
    # metrics = {
    #     "nodes_expanded": nodes_expanded,  # Persona 2 puede exponer esto
    ...
    #
    raise NotImplementedError("Persona 5: implementar ids_decision()")
